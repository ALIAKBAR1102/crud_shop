...
def print_main_menu():
    ...
    print ('#################################')
    print ("наши котегории: electronics | jewelery | men's  clothing | women's clothing |")
    print ('Выбирите действия:')
    print ('1. Получиты продукты по выбраной категории')
    print ('2. Получиты список всех товаров')
    print ('3. Получиты список всех карзин')
    print ('4. Выход')
...
def get_all_products():
    ...
    if response.status_code == 200:
        ...
        print ('Ошибка при получени всех продуктов.')
    ...
    if not cart:
        ...
        for product_id in cart:
            ...
            if response.status_code == 200:
                ...
                print (f'{product['id']}, Названия: {product['title']}, Цена: ${product['price']}')
            else:
                print(f'Ошибка при получения продуктов с ID {product_id}.')
                
def add_ro_cart(product_id):
    global cart
